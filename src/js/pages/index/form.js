...
const addLoading = () => {
  button.innerHTML = '<span class="material-symbols-outlined !text-4xl cursor-pointer !animate-spin">refresh</span>';
}
const removeLoading = () => {
  button.innerHTML = '<span class="material-symbols-outlined !text-4xl cursor-pointer translate-x-[1px]">send</span>';
}
